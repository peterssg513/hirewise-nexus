  ...
  return (
    <section className="py-16 bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10">
        <Sparkles className="text-psyched-yellow h-5 w-5 opacity-50" />
      </div>
      ...
      <div className="psyched-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-psyched-indigo/20 flex items-center justify-center mb-4">
              <Search className="text-psyched-indigo h-8 w-8" />
            </div>
          ...
          {/* Step 2 */}
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-psyched-purple/20 flex items-center justify-center mb-4">
              <Users className="text-psyched-purple h-8 w-8" />
            </div>
          ...
          {/* Step 3 */}
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-psyched-lightPurple/20 flex items-center justify-center mb-4">
              <CheckSquare className="text-psyched-lightPurple h-8 w-8" />
            </div>
