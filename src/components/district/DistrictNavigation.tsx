...
const DistrictNavigation = () => {
  ...
  return (
    <div className="mb-6 overflow-x-auto flex gap-2 md:gap-4 pb-2">
      <Button 
        variant={location.pathname.endsWith('/district-dashboard') || location.pathname.endsWith('/district-dashboard/jobs') ? "default" : "outline"} 
        asChild
        className="whitespace-nowrap"
      >
        <Link to="/district-dashboard/jobs">
      ...
      <Button 
        variant={location.pathname.includes('/district-dashboard/schools') ? "default" : "outline"} 
        asChild
        className="whitespace-nowrap"
      >
      ...
      <Button 
        variant={location.pathname.includes('/district-dashboard/students') ? "default" : "outline"} 
        asChild
        className="whitespace-nowrap"
      >
        <Link to="/district-dashboard/students">
      ...
      <Button 
        variant={location.pathname.includes('/district-dashboard/evaluations') ? "default" : "outline"} 
        asChild
        className="whitespace-nowrap"
      >
      ...
      <Button 
        variant={location.pathname.includes('/district-dashboard/settings') ? "default" : "outline"} 
        asChild
        className="whitespace-nowrap"
      >
