...
const DistrictNavigation = () => {
  ...
  return <div className="mb-6 overflow-x-auto flex gap-2 md:gap-4 pb-2">
      <Button variant={location.pathname.endsWith('/district-dashboard') || location.pathname.includes('/district-dashboard/jobs') ? "default" : "outline"} asChild className="whitespace-nowrap">
