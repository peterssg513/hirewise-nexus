...
import { Student, createStudent, CreateStudentParams } from '@/services/studentService';
...
export const CreateStudentDialog: React.FC<CreateStudentDialogProps> = ({
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      const studentParams: CreateStudentParams = {
      ...
      const newStudent = await createStudent(studentParams);
